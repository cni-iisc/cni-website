...
<div class="tab">
  ...
  <button class="tablinks" onclick="clickTab(event, 'past')">past2</button>
</div>
...
<ul class="jekyllcodex_accordion">
   <li><input id="talk0" type="checkbox" /><label for="talk0">{{"### Curbs delay, but don’t prevent Omicron spread: Study
