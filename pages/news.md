...
<ul class="jekyllcodex_accordion">
   <li><input id="news1" type="checkbox" /><label for="news1">{{"### Curbs delay, but don’t prevent Omicron spread: Study" | markdownify}}{{"The Deccan Herald, 30 January 2022"|markdownify}}</label>
